...
<section class="banner-section">
    ...
    <div class="container">
        <div class="banner-content">
            <h1 class="title  cd-headline clip"><span class="d-block">your movies</span> for
                <span class="color-theme cd-words-wrapper p-0 m-0">
                    <b class="is-visible">find</b>
                </span>
            </h1>
        </div>
    </div>
                ...
                <div class="tab-item active">
                    <form class="ticket-search-form" method="post" action="?route=search">
                        <div class="form-group large">
                            <input type="text" name="search" placeholder="Tìm kiếm phim..." name="keyword" />
